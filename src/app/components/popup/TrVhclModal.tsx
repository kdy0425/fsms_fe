...
export const TrVhclModal = (props: TrVhclModal) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let endpoint: string =
        `${url}?page=${params.page - 1}&size=${params.size}` +
      ...
      <DialogContent>
        <Box className='table-bottom-button-group'>
          ...
          <div className=" button-right-align">
              <Button variant="contained" color="primary" onClick={(fetchData)}>조회</Button>
              <Button variant="contained" color="inherit" onClick={(handleClickClose)}>닫기</Button>
          </div>
        </Box>
        {/* 검색영역 시작 */}
          ...
          <Box className="sch-filter-box">
            ...
            <div className="filter-form">
              ...
              <div className="form-group">
                ...
                <CustomTextField name="brno" value={params.vonrNm} onChange={handleSearchChange}/>
              </div>
            </div>
          </Box>
        </Box>

                ...
                rows.length > 0 ? rows.map((row: any, index) => {
                  return (
                    <TableRow key={'tr'+index}>
                      ...
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {getDateTimeString(row.opbizYmd, 'date')?.dateString}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {getDateTimeString(row.tcbizBgngYmd, 'date')?.dateString}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {getDateTimeString(row.tcbizEndYmd, 'date')?.dateString}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {getDateTimeString(row.clsbizYmd, 'date')?.dateString}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap'}}>
                        {row.vhclTonNm}
                      </TableCell>

            ...
            <TableBody>
              {!loading ? 
                rows.length > 0 ? rows.map((row: any, index) => {
                  return (
                    <TableRow key={'tr'+index} hover onClick={() => handleRowClick(index, row) } 
                    selected={index == selectedIndex}>
                      <TableCell>{row.vhclNo}</TableCell>
                      <TableCell>{row.vonrNm}</TableCell>
                      <TableCell>{row.vonrRrno}</TableCell>
                      <TableCell>{formBrno(row.vonrBrno)}</TableCell>
                      <TableCell>{row.koiNm}</TableCell>
                      <TableCell>{row.vhclTonNm}</TableCell>
                      <TableCell>{formatDate(row.bgngYmd)}</TableCell>
                      <TableCell>{formatDate(row.endYmd)}</TableCell>
                      <TableCell>{row.localNm}</TableCell>
                    </TableRow>
                  )
                }) : 
                <TableRow key={'tr0'}>

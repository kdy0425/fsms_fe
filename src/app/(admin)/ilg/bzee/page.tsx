...
const DataList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let endpoint: string =
        `/fsm/ilg/bzee/tx/getAllBizZoneExclElctcList?page=${params.page - 1}&size=${params.size}` +
  ...
  return (
    <PageContainer title="사업구역외충전" description="사업구역외충전">
      {/* breadcrumb */}
      <Breadcrumb title="사업구역외충전" items={BCrumb} />
      {/* end breadcrumb */}

        ...
        <div className="table-scrollable">
          ...
          <TableHead>
              <TableRow>
                ...
                <TableCell style={{whiteSpace:'nowrap'}} colSpan={6}>운전자면허정보</TableCell>{/* 합계 헤더 */}
              </TableRow>
              <TableRow>
              ...
              {loading ? (
                ...
                rows.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell className='td-center'>{row.vhclPsnCd}</TableCell>
                    <TableCell className='td-center'>{row.vhclSttsCdNm}</TableCell>
                    <TableCell className='td-center'>{formatDate(row.carRegDt ?? '')}</TableCell>

                    <TableCell className='td-center'>{row.driverVonrNm}</TableCell>
                    <TableCell className='td-center'>{row.driverVonrRrnoS}</TableCell>
                    <TableCell className='td-center'>{formatDate(row.ctrtBgngYmd ?? '')}</TableCell>
                    <TableCell className='td-center'>{formatDate(row.ctrtEndYmd ?? '')}</TableCell>
                    <TableCell className='td-center'>{row.TELNO}</TableCell>
                    <TableCell className='td-center'>{formatDate(row.driverRegDt ?? '')}</TableCell>

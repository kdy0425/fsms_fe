...
const DataList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let endpoint: string =
        `/fsm/apv/ddd/cm/getAllDalyDelngDtls?page=${params.page - 1}&size=${params.size}` +
  ...
  const fetchDetailData = async () => {
    try {
      let endpoint = `/fsm/apv/ddd/cm/getAllDelngDtls?page=${detailParams.page - 1}&size=${detailParams.size}` +
  ...
  return (
    <PageContainer title="일별거래내역" description="일별거래내역">
        ...
        <Box className="sch-filter-box">
          <div className="filter-form">
            <div className="form-group">
              ...
              <CustomFormLabel className="input-label-none" htmlFor="ft-date-start">거래일자 시작</CustomFormLabel>
              ...
              ~ 
              <CustomFormLabel className="input-label-none" htmlFor="ft-date-end">거래일자 종료</CustomFormLabel>
      ...
      <Box>
        <TableDataGrid
          headCells={vhclFalg? vhclHeadCells : headCells} // 테이블 헤더 값
          rows={rows} // 목록 데이터

                ...
                rows.length > 0 ? rows.map((row: any, index) => {
                  return (
                    <TableRow key={'tr'+index}>
                      ...
                      <TableCell>
                        {getLabelFormCrdCod(row.crdcoCd)}
                      </TableCell>
                      <TableCell>
                        {getLabelFromCity(searchCityCode)+' '+getLabelFromLocalGov(row.clclnLocgovCd)}
                      </TableCell>
                      <TableCell>
                        {getLabelFromBzmnSe(row.bzmnSeCd)}
                      </TableCell>

                      <TableCell>
                        {getLabelFromKoi(row.koiCd)}
                      </TableCell>
                      <TableCell>

    ...
    <ThemeProvider theme={themeWithLocale}> 
      <div className="data-grid-wrapper">
        ...
        <div className="table-scrollable">
          ...
          <TableHead>
            <TableRow>
              <TableCell style={{whiteSpace:'norwap'}}>청구년월</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>면허업종</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>차량번호</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>수급자주민번호</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>수급자명</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>카드사</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>카드번호</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>승인번호</TableCell>
              <TableCell style={{whiteSpace:'norwap'}} colSpan={2}>거래일시</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>거래구분</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>유종</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>주유·충전량</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>거래금액</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>개인부담금</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>유가보조금</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>유류세연동보조금</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>가맹점</TableCell>
              <TableCell style={{whiteSpace:'norwap'}} colSpan={2}>지급확정</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>사업자번호</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>업체명</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {!loading ? 

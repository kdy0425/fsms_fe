      ...
      <div className="data-grid-wrapper">
        ...
        <div className="table-scrollable">
          ...
          <TableHead>
            ...
            <TableRow>
              <TableCell style={{whiteSpace:'norwap'}}>매출건수</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>국토부사용량</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>단위</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>매출금</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>개인부담금</TableCell>
              <TableCell style={{whiteSpace:'norwap'}}>국토부보조금</TableCell>

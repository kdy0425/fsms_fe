                  ...
                  rows.map((row: any, index) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell>{row.vonrBrno}</TableCell>
                        <TableCell>{row.regDt}</TableCell>
                        <TableCell>{row.trsmDt}</TableCell>
                        <TableCell>{row.bfchgTnkCpcty}</TableCell>
                        <TableCell>{row.tnkCpcty}</TableCell>
                        <TableCell>{row.tankStsNm}</TableCell>
                        <TableCell>{row.reason}</TableCell>
                        <TableCell>{row.mdfcnDt}</TableCell>
                      </TableRow>
                    )
                  })
                ) : (
          ...
          detailViewButtonActions ? (
            <Grid item xs={4} sm={4} md={4}>
              <DetailDataGrid
                ...
                onClickApproveBtn={detailViewButtonActions.onClickApproveBtn}
                onClickDeclineBtn={detailViewButtonActions.onClickDeclineBtn}
              />
            </Grid>
          ) : (
            ''

                  ...
                  rows.map((row: any, index) => {
                    return (
                      <TableRow
                        hover
                        key={'tr' + index}
                        onClick={() => onRowClick(row.procNm)}
                      >
                        <TableCell>
                          <Button onClick={(e) => onClickButton(row.procNm, e)}>
                            재실행
                          </Button>
                        </TableCell>
                        <TableCell>{row.procNm}</TableCell>
                        <TableCell>{row.procKornNm}</TableCell>
                        <TableCell>{row.dlngNm}</TableCell>
                        <TableCell>{row.useYn}</TableCell>
                        <TableCell>{row.schdulSeCd}</TableCell>
                        <TableCell>{row.schdulExcnYmd}</TableCell>
                        <TableCell>{row.excnBgngYmd}</TableCell>
                        <TableCell>{row.excnBgngTm}</TableCell>
                        <TableCell>{row.excnEndYmd}</TableCell>
                        <TableCell>{row.excnEndTm}</TableCell>
                        <TableCell>{row.excnNocs}</TableCell>
                        <TableCell>{row.schdulPrgrsSttsNm}</TableCell>
                        <TableCell>{row.prcsNocs}</TableCell>
                        <TableCell>{row.errorNocs}</TableCell>
                      </TableRow>
                    )
                  })
                ) : (

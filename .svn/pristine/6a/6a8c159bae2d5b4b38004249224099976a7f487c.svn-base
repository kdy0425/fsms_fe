              ...
              {stableSort(rowData, getComparator(order, orderBy))
                ...
                .map((row: any) => (
                  ...
                  >
                    ...
                    <TableCell>{row.rprsvRrno}</TableCell>
                    <TableCell>{row.koiCd}</TableCell>
                    <TableCell>{row.tons}</TableCell>
                    <TableCell>{row.vhclSeCd}</TableCell>
                    <TableCell>{row.dscntYn}</TableCell>
                    <TableCell>{row.rfidYn}</TableCell>
                  </TableRow>
                ))}
            </TableBody>
          </Table>

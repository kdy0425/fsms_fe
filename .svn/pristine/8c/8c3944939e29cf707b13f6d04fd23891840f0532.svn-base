  ...
  return (
    ...
    <ThemeProvider theme={themeWithLocale}> 
      <div className="data-grid-wrapper">
        <Box className="table-bottom-button-group" style={{padding:'10px 0'}}>
          ...
          <caption>
            ...
            <TableBody>
              {!loading ? 
                ...
                <TableRow key={'tr0'}>
                  <TableCell colSpan={headCells.length + 5} className='td-center'><p>자료가 없습니다. 다른 검색조건을 선택해주세요.</p></TableCell>
                </TableRow>
              : 
              <TableRow key={'tr0'}>
                <TableCell colSpan={headCells.length + 5} className='td-center'><p> </p></TableCell>
              </TableRow>
            }
            </TableBody>
          </Table>

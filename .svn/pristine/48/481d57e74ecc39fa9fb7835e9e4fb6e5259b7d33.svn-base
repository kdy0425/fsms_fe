        ...
        <TableContainer sx={{ maxHeight: 750}}>
          ...
          >
            ...
            {!loading ? 
                ...
                <TableRow key={'tr0'}>
                  <TableCell colSpan={headCells.length + (subHeadCells? subHeadCells.length : 0)} className='td-center'><p>자료가 없습니다. 다른 검색조건을 선택해주세요.</p></TableCell>
                </TableRow>
              : 
              <TableRow key={'tr0'}>
                <TableCell colSpan={headCells.length + (subHeadCells? subHeadCells.length : 0)} className='td-center'><p> </p></TableCell>
              </TableRow>
            }
            </TableBody>
          </Table>

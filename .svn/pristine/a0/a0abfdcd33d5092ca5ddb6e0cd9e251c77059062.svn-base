...
const DataList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let endpoint: string =
        `/fsm/ilg/ddal/tr/getAllDoubtDelngDtls?page=${params.page - 1}&size=${params.size}` +
  ...
  return (
    <PageContainer title="주행거리 기반 주유량 의심주유" description="주행거리 기반 주유량 의심주유">
      {/* breadcrumb */}
        ...
        <Box className="sch-filter-box">
          ...
          <div className="filter-form">
            <div className="form-group">
              ...
              <CustomTextField name="brno" value={params.vhclNo} onChange={handleSearchChange} fullWidth />
            </div>
            <div className="form-group">
              <CustomFormLabel
                className="input-label-display"
              ...
              <CustomTextField name="brno" value={params.frcsNm} onChange={handleSearchChange} fullWidth />
            </div>
            <div className="form-group">
              <CustomFormLabel
                className="input-label-display"

...
const DataList = () => {
  ...
  const createCodeGroup = async (params: any) => {
    alert("그룹저장");
    // try {
    //   let endpoint = `/fsm/sym/cc/cm/createCmmnCdGroup`

    //   const body = {
    //     "cdGroupNm": params.cdGroupNm,
    //     "cdKornNm": params.cdKornNm,
    //     "cdSeNm": params.cdSeNm,
    //     "cdExpln": params.cdExpln,
    //     "useYn": params.useYn,
    //     "comCdYn": params.comCdYn
    //   }
  ...
  const createCode = async (params: any, e: Event) => {
    alert("코드저장");
  }
        ...
        <Box className="table-bottom-button-group">
          ...
          <div className="button-right-align">
            ...
            {/* <CustomDialog
              ...
              title='코드그룹등록'
              btnSet={
                <Button variant="contained" color="primary" onClick={createCodeGroup}>저장</Button>
              }
        ...
        <Box className="table-bottom-button-group">
          ...
          <div className="button-right-align">
            {/* <CustomDialog
                ...
                title='공통코드등록'
                btnSet={
                  <Button variant="contained" color="primary" onClick={createCode}>저장</Button>
                }
                children={<ModalContent 

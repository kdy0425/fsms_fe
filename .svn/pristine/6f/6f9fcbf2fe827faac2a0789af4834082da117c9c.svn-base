...
import { Box, Button, FormControlLabel, IconButton, MenuItem, RadioGroup, Table, TableBody, TableCell, TableContainer, TableRow } from '@mui/material';
...
const ModalContent = (props : ModalContentProps) => {
  ...
  const handleRowClick = (rowData: Row) => {
    setParams(
      (prev) => ({ ...prev, clclnLocgovCd:rowData['clclnLocgovCd'], clclnLocgovNm:rowData['clclnLocgovNm'] })
    )
  }
        ...
        >
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell colSpan={3}>
                <CustomTextField type="text" id="modal-locgovCd" name="locgovCd" value={params.locgovCd} onChange={handleParamChange} fullWidth />
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className='table-title-column'>
              ...
              <TableCell colSpan={3}>
                <CustomTextField type="text" id="modal-locgovNm" name="locgovNm" value={params.locgovNm} onChange={handleParamChange} fullWidth/>
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className='table-title-column'>

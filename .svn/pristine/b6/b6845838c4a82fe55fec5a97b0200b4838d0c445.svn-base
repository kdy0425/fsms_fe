                ...
                rows.length > 0 ? rows.map((row: any, index) => {
                  return (
                    <TableRow key={'tr'+index}>
                      ...
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {Number(row.asstAmt).toLocaleString('ko-KR')}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap'}}>
                        {row.ceckStlmYnNm}
                      </TableCell>
                      ...
                      <TableCell style={{whiteSpace:'nowrap'}}>
                        {getDateTimeString(row.bfrInspYmd, 'date')?.dateString}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap'}}>
                        {getDateTimeString(row.regDt, 'date')?.dateString}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {row.oprDstnc?.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {row.totlUseLiter?.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {row.vhclEfficiency?.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </TableCell>
                      <TableCell style={{whiteSpace:'nowrap', textAlign:'right'}}>
                        {row.mileg?.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </TableCell>
